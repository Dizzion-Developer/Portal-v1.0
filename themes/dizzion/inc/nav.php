    ...
    <nav id="primary-nav">
        ...
        <ul>
            <?php foreach ($primary_nav as $key => $link) {
                ...
                $active = (isset($link['url']) && (strstr($template['active_page'],$link['url']))) ? ' class="active"' : '';
                ...
                if (isset($link['sub']) && $link['sub']) {
                    foreach ($link['sub'] as $sub_link) {
                        if (strstr($template['active_page'], $sub_link['url'])) {
                ...
                <?php if (isset($link['sub']) && $link['sub']) { ?>
                    <ul>
                        <?php foreach ($link['sub'] as $sub_link) {
                            ...
                            $active = (isset($sub_link['url']) && (strstr($template['active_page'],$sub_link['url']))) ? ' class="active"' : '';
