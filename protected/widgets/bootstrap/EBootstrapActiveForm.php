...
class EBootstrapActiveForm extends CActiveForm {
     ...
     * Default: help-inline
     */
    public $errorMessageCssClass = 'help-inline errorMessage';
    ...
    /*
     * Render a checkboxlist with a append icon
     *
     * @param CModel $model The model
     * @param string $attribute The attribute
     * @param string $data value-label pairs used to generate the check box list.
     * @param array $htmlOptions
     * @param array $icon icon to append
     */

    public function iconCheckBoxList($model, $attribute, $data, $htmlOptions = array(), $icon = array(),$status=array()) {
        return EBootstrap::imgactiveCheckBoxList($model, $attribute, $data, $htmlOptions, $icon,$status);
    }
     ...
     * @param array $htmlOptions
     */
    public function submitButtonSecondary($label, $htmlOptions = array()) {
        EBootstrap::mergeClass($htmlOptions, array('btn', 'btn-secondary'));
        return EBootstrap::submitButton($label, '', '', '', '', '', $htmlOptions);
    }
}
